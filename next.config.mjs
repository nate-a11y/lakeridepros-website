...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/luxury-shuttle-bus', destination: '/fleet/executive-shuttle-bus', permanent: true },
      { source: '/rescue-squad-1', destination: '/fleet/rescue-squad-1', permanent: true },
      { source: '/lrp-limo-bus', destination: '/fleet/lrp-limo-bus', permanent: true },
      { source: '/luxury-sprinter-van', destination: '/fleet/executive-sprinter-van', permanent: true },
      { source: '/fleet/limo-bus', destination: '/fleet/lrp-limo-bus', permanent: true },
      { source: '/fleet/sprinter-van', destination: '/fleet/executive-sprinter-van', permanent: true },
      { source: '/fleet/shuttle-bus', destination: '/fleet/executive-shuttle-bus', permanent: true },
      { source: '/fleet/rescue-squad', destination: '/fleet/rescue-squad-1', permanent: true },
      { source: '/fleet/suburbans', destination: '/fleet', permanent: true },

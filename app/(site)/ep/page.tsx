            ...
            <div key={release.title} className="flex flex-col items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
                <Link
                  ...
                  className="flex-1 flex items-center justify-center gap-3 px-6 py-4 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 rounded-xl font-semibold text-lg hover:opacity-90 transition-opacity"
                >

      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 space-y-4">
          <div>
            <div className="flex items-center">
              ...
              />
              <label htmlFor="revoked" className="ml-2 text-sm text-gray-700 dark:text-gray-200">
          ...
          <div>
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 dark:focus:ring-blue-400 border-gray-300 dark:border-gray-600 rounded"
              />
              <label htmlFor="accidents" className="ml-2 text-sm text-gray-700 dark:text-gray-200">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <div className="flex items-start mb-4">
            ...
            />
            <label htmlFor="authorize" className="ml-3 text-sm text-gray-700 dark:text-gray-200">

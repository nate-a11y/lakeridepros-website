    ...
    defineField({
      ...
      options: {
        list: [
          ...
          {title: 'Catering Services', value: 'catering-services'},
    ...
    defineField({
      ...
      options: {
        list: [
          ...
          {title: 'Travel Agents', value: 'travel-agents'},
          {title: 'DJs / Live Bands', value: 'djs-live-bands'},
          {title: 'Bartenders / Mobile Bar Services', value: 'bartenders-mobile-bar-services'},

...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Accessibility Statement | Lake Ride Pros',
    description: 'Lake Ride Pros is committed to ensuring digital accessibility for people with disabilities.',
    url: 'https://www.lakeridepros.com/accessibility',
    siteName: 'Lake Ride Pros',
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'Lake Ride Pros Accessibility' }],
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
    ...
    title: 'Accessibility Statement | Lake Ride Pros',
    description: 'Lake Ride Pros is committed to ensuring digital accessibility.',
    images: ['/og-image.jpg'],
  },
}
  ...
  return (
    <div className={styles.page}>
      <article className={styles.reading}>
        <h1 className="text-4xl font-bold text-lrp-black mb-8">
          Accessibility Statement
        </h1>

        <section className="prose prose-lg max-w-none">
          <h2 className="text-2xl font-bold text-lrp-black mt-8 mb-4">
            Our Commitment
          </h2>
          ...
          <div className="bg-neutral-50 rounded-lg p-6 mb-6">
            ...
            <ul className="space-y-3">
              <li>
                <strong className="text-lrp-black">Email:</strong>{' '}
                <a
              ...
              <li>
                <strong className="text-lrp-black">Phone:</strong>{' '}
                <PhoneLink
                  className="text-primary hover:text-primary-dark underline"
                >
                  (573) 206-9499
              ...
              <li>
                <strong className="text-lrp-black">Contact Form:</strong>{' '}
                <Link
                  href="/contact"
                  className="text-primary hover:text-primary-dark underline"
                >
          ...
          <div className="bg-primary/10 border-l-4 border-primary rounded-r-lg p-6 mt-8">
            <p className="text-neutral-800 font-medium">
              <strong className="text-lrp-black">Last Updated:</strong> January 2025
            </p>
          </div>

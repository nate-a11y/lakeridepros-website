...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    support: [
      ...
      { name: 'Check Balance', href: '/gift-card-balance' },
      { name: 'Shop', href: '/shop' },
      { name: 'FAQ', href: '/faq' },
    ],
  };
  ...
  return (
    <footer className="bg-primary-dark dark:bg-dark-bg-primary text-white transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            <Link href="/" className="inline-block mb-4">
              <Image
                ...
                width={140}
                height={47}
                className="w-36 h-auto brightness-0 invert dark:brightness-100 dark:invert-0"
              />
            </Link>
            <p className="text-sm mb-4 opacity-90 dark:text-neutral-300">
              Safe rides, good times. Premium transportation services at Lake of the Ozarks, Missouri.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-white opacity-70 hover:opacity-100 hover:text-primary-light dark:hover:text-primary transition-all">
            ...
            <ul className="space-y-2">
              {footerLinks.services.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-sm text-white dark:text-neutral-300 opacity-90 hover:opacity-100 hover:text-primary-light dark:hover:text-primary transition-all"
                  >
                    {link.name}
                  </Link>
                </li>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white border-opacity-20 dark:border-dark-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-white dark:text-neutral-300 opacity-80">

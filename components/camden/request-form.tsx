...
export function NewRequestForm() {
  ...
  async function submitLocationRequest() {
    ...
    try {
      ...
      setLocationFeedback("Location submitted for LRP approval. It cannot be selected until approved.")
  ...
  return (
    <PortalShell context={data.context}>
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-3"><p className="text-sm font-bold text-[#245f0b]">{duplicateId ? "Duplicate a prior request" : "New transportation request"}</p><h1 className="mt-1 text-3xl font-extrabold tracking-tight">Tell us about the ride</h1><p className="mt-2 text-neutral-600">Submitting a request does not guarantee transportation. Your ride is confirmed only after it is scheduled and linked to a Moovs reservation.</p></div>

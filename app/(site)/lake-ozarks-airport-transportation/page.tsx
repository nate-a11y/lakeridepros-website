    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-dark-bg-primary">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6">
              <Link href="/kansas-city-to-lake-ozarks" className="group block bg-lrp-gray dark:bg-dark-bg-secondary p-6 rounded-lg hover:bg-lrp-green hover:text-white transition-all">
              ...
              <Link href="/st-louis-to-lake-ozarks" className="group block bg-lrp-gray dark:bg-dark-bg-secondary p-6 rounded-lg hover:bg-lrp-green hover:text-white transition-all">
                <div className="flex items-center justify-between">
                  <div>
        ...
        <RelatedServices services={[
          ...
          { title: "Private Aviation Transportation", href: "/services/private-aviation-transportation", description: "Executive FBO coordination and luxury transfers" }
        ]} />

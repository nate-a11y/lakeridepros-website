...
class BffCamdenService implements CamdenPortalService {
  ...
  createChangeProposal(id: string, version: number, reasonId: string, explanation: string, proposal: CamdenChangeProposal) { return this.request<CamdenActionResult>("create-change-proposal", { method: "POST", body: { id, version, reasonId, explanation, proposal } }) }

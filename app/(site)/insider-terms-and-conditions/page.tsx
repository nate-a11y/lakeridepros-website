      ...
      <section className="py-16 bg-white dark:bg-dark-bg">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            {/* Section 1 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">1. Membership Fees</h2>
            ...
            {/* Section 2 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">2. Earning Points</h2>
            <h3 className="text-xl font-semibold text-neutral-800 dark:text-neutral-200 mt-6 mb-3">Point-to-Point Reservations</h3>
            <ul className="list-disc pl-6 mb-4 text-neutral-700 dark:text-neutral-300">
              <li>One-Way Trips: Earn 1 point</li>
              <li>Round Trips: Earn 2 points</li>
              <li>Additional Stops: Do not earn points</li>
            </ul>
            <h3 className="text-xl font-semibold text-neutral-800 dark:text-neutral-200 mt-6 mb-3">Hourly Reservations</h3>
            ...
            {/* Section 3 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">3. Membership Levels</h2>
            <h3 className="text-xl font-semibold text-neutral-800 dark:text-neutral-200 mt-6 mb-3">Individual Memberships</h3>
            <ul className="list-disc pl-6 mb-4 text-neutral-700 dark:text-neutral-300">
            ...
            <h3 className="text-xl font-semibold text-neutral-800 dark:text-neutral-200 mt-6 mb-3">Family and Business Memberships</h3>
            <ul className="list-disc pl-6 mb-6 text-neutral-700 dark:text-neutral-300">
            ...
            {/* Section 4 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">4. Redeeming Points</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-6">
            ...
            {/* Section 5 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">5. Cancellation, Hold Status, and Termination</h2>
            <h3 className="text-xl font-semibold text-neutral-800 dark:text-neutral-200 mt-6 mb-3">Cancellation</h3>
            ...
            <h3 className="text-xl font-semibold text-neutral-800 dark:text-neutral-200 mt-6 mb-3">Hold Status</h3>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-neutral-800 dark:text-neutral-200 mt-6 mb-3">Termination by the Company</h3>
            <p className="text-neutral-700 dark:text-neutral-300 mb-6">
            ...
            {/* Section 6 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">6. Liability</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-6">
            ...
            {/* Section 7 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">7. Accessibility Compliance</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-6">
            ...
            {/* Section 8 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">8. How Lake Ride Pros Insiders Works</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
            ...
            {/* Section 9 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">9. Geographic Scope</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-6">
            ...
            {/* Section 10 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">10. Program Changes</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-6">
            ...
            {/* Section 11 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">11. Amendments to Terms</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-6">
            ...
            {/* Section 12 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">12. Transfer of Rights</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-6">
            ...
            {/* Section 13 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">13. Minimum Fare</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-6">
              A minimum fare of $13.00 applies to all rides taken under the Lake Ride Pros Insiders Program.
            </p>

            {/* Section 14 */}
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mt-10 mb-4">14. Contact Us</h2>
            <p className="text-neutral-700 dark:text-neutral-300 mb-2">
              For questions or concerns about your membership, contact us at:
            </p>
            <ul className="list-none pl-0 mb-6 text-neutral-700 dark:text-neutral-300">
            ...
            {/* Copyright */}
            <p className="text-neutral-600 dark:text-neutral-400 text-center mt-12 pt-8 border-t border-neutral-200 dark:border-neutral-700">

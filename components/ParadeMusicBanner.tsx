...
// Calculate events based on current date - runs only on client
function calculateEvents(): ParadeEvent[] {
  const now = new Date();
  const december7_2025 = new Date(2025, 11, 7);
  const december14_2025 = new Date(2025, 11, 14);

  // Hide banner after December 13, 2025
  if (now >= december14_2025) return [];

  // Before December 7, show both events

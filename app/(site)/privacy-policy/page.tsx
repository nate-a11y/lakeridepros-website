    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lake Ride Pros Privacy Policy',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.reading}>
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            <p className="text-lrp-black mb-4">
              Lake Ride Pros LLC ("we," "us," or "our") operates
              www.lakeridepros.com and provides transportation services at Lake
              of the Ozarks, Missouri. This Privacy Policy explains how we
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-lrp-green-dark mb-4">
            ...
            <ul className="list-disc pl-6 text-lrp-black mb-4 space-y-2">
              ...
              <li>Enroll in or use an Insider Rewards membership</li>
            </ul>
            <p className="text-lrp-black mb-4">
              This information may include:
            </p>
            <ul className="list-disc pl-6 text-lrp-black mb-6 space-y-2">
              <li>
                Name and contact information (email, phone number, address)
              </li>
              <li>Pickup and drop-off locations</li>
              <li>
                Payment information (processed securely through Stripe or
                Chargebee)
              </li>
              <li>Trip details and preferences</li>
              <li>Special requests or accessibility needs</li>
              <li>
                Insider membership, approved-rider, rewards, benefit, and
                support-request records
              </li>
              <li>
                Email, push-notification, and optional text-message preferences
                and consent records
              </li>
            </ul>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-lrp-black mb-4 space-y-2">
              ...
              <li>
                Administer Insider Rewards, match eligible Moovs trips,
                calculate status, and provide member benefits
              </li>
              <li>
                Deliver in-account, email, push, or optional text notifications
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-lrp-black mb-6 space-y-2">
              <li>
                <strong>Moovs:</strong> Our booking platform partner for
              ...
              <li>
                <strong>Chargebee:</strong> Insider membership checkout,
                recurring billing, and billing self-service
              </li>
              <li>
                <strong>Supabase:</strong> Secure account authentication and
                application data services
              </li>
              <li>
                <strong>Resend and other email service providers:</strong>{' '}
                Account and customer communications
              </li>
              <li>
                <strong>Twilio:</strong> Optional text messages when you have
                expressly opted in
              </li>
              <li>
            ...
            <p className="text-lrp-black mb-4">
              If Lake Ride Pros is involved in a merger, acquisition, or sale of
          ...
          <section className="mb-12">
            ...
            <p className="text-lrp-black">
              ...
              <a
                ...
                className="text-lrp-green-dark hover:text-lrp-green"
              >
          ...
          <section className="mb-12">
            ...
            <p className="text-lrp-black">
              Booking and payment records are typically retained for 7 years to
              comply with financial regulations. Marketing data is retained
          ...
          <section className="mb-12">
            ...
            <p className="text-lrp-black">
              ...
              our booking platform (Moovs). We are not responsible for the
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-lrp-black mb-4 space-y-2">
              <li>
                <strong>Transactional emails:</strong> Booking confirmations,
                receipts, and service updates (required)
              </li>
              <li>
                <strong>Marketing emails:</strong> Promotions, news, and special
                offers (optional)
              </li>
              <li>
                <strong>Insider account notices:</strong> Rewards, benefits,
                billing, local perks, events, and support updates shown in the
                member portal
              </li>
              <li>
                <strong>Push notifications:</strong> Browser or mobile alerts
                enabled through your device permission
              </li>
              <li>
                <strong>Text messages:</strong> Optional recurring Insider
                messages sent only after express opt-in
              </li>
            </ul>
            <p className="text-lrp-black mb-4">
              You can opt out of marketing emails by clicking "unsubscribe" in
              any marketing email or by contacting us directly. You cannot opt
              out of transactional emails related to your bookings.
            </p>
            <p className="text-lrp-black">
              Insider members can update email, push, text, and category
              preferences in the member portal. You may also disable push in
              your browser or device settings and reply STOP to opt out of text
        ...
        {/* Contact Card */}
        <div className="mt-12 bg-lrp-gray p-6 rounded-lg">

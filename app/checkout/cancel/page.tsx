  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg-primary py-20">
      <div className="container mx-auto px-4 max-w-2xl text-center">
        {/* Cancel Icon */}
        <div className="w-24 h-24 bg-gray-200 dark:bg-dark-bg-secondary rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="/shop"
            className="inline-flex items-center justify-center gap-2 border-2 border-gray-300 dark:border-dark-border hover:bg-gray-100 dark:hover:bg-dark-bg-secondary text-gray-900 dark:text-white px-8 py-4 rounded-lg font-bold transition-all"
          >
            Continue Shopping
          </Link>
        </div>

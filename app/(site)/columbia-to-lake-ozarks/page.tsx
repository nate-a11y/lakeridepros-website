...
import { MapPin, GraduationCap, Users, Clock, CheckCircle, Star, Phone, ArrowRight } from 'lucide-react'
...
export default function ColumbiaToLakeOzarksPage() {
  return (
    <>
      <script
        ...
        <section className="py-16 bg-lrp-gray dark:bg-dark-bg-secondary">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6">
              <Link href="/bachelor-party-transportation" className="group block bg-white dark:bg-dark-bg-primary p-6 rounded-lg hover:bg-lrp-green hover:text-white transition-all">
              ...
              <Link href="/wedding-transportation" className="group block bg-white dark:bg-dark-bg-primary p-6 rounded-lg hover:bg-lrp-green hover:text-white transition-all">
                <div className="flex items-center justify-between">
                  <div>
              ...
              <Link href="/group-event-transportation" className="group block bg-white dark:bg-dark-bg-primary p-6 rounded-lg hover:bg-lrp-green hover:text-white transition-all">
                <div className="flex items-center justify-between">
                  <div>
              ...
              <Link href="/nightlife-transportation" className="group block bg-white dark:bg-dark-bg-primary p-6 rounded-lg hover:bg-lrp-green hover:text-white transition-all">
                <div className="flex items-center justify-between">
                  <div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto bg-white dark:bg-dark-bg-primary p-8 rounded-lg">
              ...
              <p className="text-gray-700 dark:text-lrp-gray text-lg italic mb-4">
                "We're Mizzou students who wanted a Lake weekend without worrying about who's driving. Lake Ride Pros picked us up from campus Friday afternoon, dropped us at our Lake house, and picked us up Sunday. Perfect for spring break trips!"
              </p>

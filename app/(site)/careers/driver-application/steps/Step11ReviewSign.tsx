        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-primary text-lrp-black font-semibold rounded-lg transition-colors hover:bg-primary-dark transition-colors"
            >
